...
// Generated on Thu, 22 Dec 2022 13:32:24 GMT
...
object StyleDictionaryColor {
  ...
  val colorFbErrorDark = Color(0xff7a2b1f)
  val colorFbErrorDarkest = Color(0xff3d150f)
  val colorFbErrorLight = Color(0xffe09185)
  val colorFbErrorLightest = Color(0xfff5dad6)
  val colorFbErrorMedium = Color(0xffe6614c)
  val colorFbSuccessDark = Color(0xff26734c)
  val colorFbSuccessDarkest = Color(0xff133926)
  val colorFbSuccessLight = Color(0xff8cd9b2)
  val colorFbSuccessLightest = Color(0xffd8f2e5)
  val colorFbSuccessMedium = Color(0xff40bf7f)
  val colorFbWarningDark = Color(0xff916808)
  val colorFbWarningDarkest = Color(0xff493404)
  val colorFbWarningLight = Color(0xfff7ce6e)
  val colorFbWarningLightest = Color(0xfffcefcf)
  val colorFbWarningMedium = Color(0xfff2ad0d)
  val colorNeutralBlack = Color(0xff000000)
  val colorNeutralGrey10 = Color(0xff171a1c)
  val colorNeutralGrey30 = Color(0xff454d54)
  val colorNeutralGrey60 = Color(0xff9299a0)
  val colorNeutralGrey80 = Color(0xffc7cdd1)
  ...
  val colorTextOnInverseDisabled = Color(0xffc7cdd1)
  val colorTextOnInverseSubtle = Color(0xff454d54)
  val colorTextSubtle = Color(0xffc7cdd1)
}
